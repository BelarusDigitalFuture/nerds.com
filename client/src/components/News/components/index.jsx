...
for (let i = 0; i < 1; i++) {
  listData.push({
    ...
    content:
      `
      12 февраля платформа geekcon.online проведёт свою первую олимпиаду по белорусскому языку и литературе. Участвовать в ней смогут школьники 10-х классов. На решение задач даётся 45 минут. И не забудьте включить белорусскую раскладку клавиатуры.
Поспехаў вам!
      `,
  });
}
